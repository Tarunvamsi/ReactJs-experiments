...
const parent2 = React.createElement(
    ...
    { id: "parent" },[React.createElement("div", { id: "child" }, [
        React.createElement("h1", {id:"child1"}, "i am sibling and h1 child1"),
        React.createElement("h2", {id:"child1"}, "i am sibling and h2 child1"),
      ]),React.createElement("div", { id: "child2" }, [
        React.createElement("h1", {id:"child2"}, "i am sibling and h1 child2"),
        React.createElement("h2", {id:"child2"}, "i am sibling and h2 child2"),
      ])]
    
  );

  nestedSiblings.render(parent2);
// above code looks soo complex and tidy
